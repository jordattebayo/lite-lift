...
namespace BE.DataAccess
{
    public class DataAccessProvider : IDataAccessProvider
    {
        ...
        {
            var workout = _context.Workouts.FirstOrDefault(w => w.Sid == sid);
            return workout != null ? workout : null;
        ...
        {
            var _set = _context.Sets.FirstOrDefault<Set>(s => s.Sid == sid);
            if (_set == null) return;
             _set.Weight = set.Weight;
            _set.Unit = set.Unit;
            _set.Reps = set.Reps;
            _set.Order = set.Order;
            _set.Category = set.Category;
            _set.Group = set.Group;
